...
@php
    ...
    $tabData = [
        ...
        'Leave Structure' => [
            ...
            array_merge($checklistTasks[2], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[3], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[4], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[5], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[6], ['status' => 'Developer Complete']),
            ...
            array_merge($checklistTasks[10], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[11], ['status' => 'Pending']),
            array_merge($checklistTasks[12], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[13], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[14], ['status' => 'Pending']),
        ],
        'Leave Application & Encashment' => [
            array_merge($checklistTasks[0], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[1], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[2], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[3], ['status' => 'Developer Complete']),
            ...
            array_merge($checklistTasks[7], ['status' => 'Pending']),
            array_merge($checklistTasks[8], ['status' => 'Pending']),
            array_merge($checklistTasks[9], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[10], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[11], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[12], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[13], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[14], ['status' => 'Pending']),
        ],
        ...
        'Asset Management' => [
            ...
            array_merge($checklistTasks[5], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[6], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[7], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[8], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[9], ['status' => 'Pending']),
            array_merge($checklistTasks[10], ['status' => 'Developer Complete']),
            array_merge($checklistTasks[11], ['status' => 'Pending']),
            array_merge($checklistTasks[12], ['status' => 'Developer Complete']),
