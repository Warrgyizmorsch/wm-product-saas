...
<div class="card border-0 mb-0 h-100 shadow-sm" style="border-radius: 16px; background: #ffffff;">
    <div class="card-header bg-white pt-3.5 pb-2.5 px-4 d-flex align-items-center justify-content-between border-bottom-0">
        <div class="d-flex align-items-center gap-2">
            <div class="d-flex align-items-center justify-content-center flex-shrink-0" style="width: 30px; height: 30px; background: #f0fdf4; border-radius: 8px; color: #16a34a;">
                <i class="feather-check-square fs-13"></i>
            </div>
            <h6 class="fw-bold mb-0 text-dark fs-14" style="color: #0f172a !important;">Approved Leaves</h6>
        </div>
        <span class="badge px-2.5 py-1 fs-11 fw-semibold rounded-pill" style="background: #dcfce7; color: #16a34a;">
                    ...
                    @foreach($leaves as $appLeave)
                        ...
                        <tr>
                            ...
                            <td class="py-2.5 pe-4 text-end border-bottom" style="border-color: #f1f5f9;">
                                <span class="fw-medium fs-12 text-secondary">{{ $startDate }} &ndash; {{ $endDate }}</span>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
