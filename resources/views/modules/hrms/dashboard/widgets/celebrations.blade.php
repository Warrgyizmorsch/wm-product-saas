...
<div class="card border-0 mb-0 h-100 shadow-sm" style="border-radius: 16px; background: #ffffff;">
    <div class="card-header bg-white pt-3.5 pb-2.5 px-4 d-flex align-items-center justify-content-between border-bottom-0">
        <div class="d-flex align-items-center gap-2">
            <div class="d-flex align-items-center justify-content-center flex-shrink-0" style="width: 30px; height: 30px; background: #fff7ed; border-radius: 8px; color: #ea580c;">
                <i class="feather-award fs-13"></i>
            </div>
            <h6 class="fw-bold mb-0 text-dark fs-14" style="color: #0f172a !important;">Celebrations This Month</h6>
        </div>
        <span class="badge px-2.5 py-1 fs-11 fw-semibold rounded-pill" style="background: #ffedd5; color: #c2410c;">
                ...
                <tbody>
                    @foreach($bDays as $bday)
                        <tr>
                            <td class="py-2.5 ps-4 border-bottom" style="border-color: #f1f5f9;">
                                <div class="fw-semibold text-dark fs-13 d-inline-flex align-items-center gap-2" style="color: #1e293b !important;">
                                    <i class="feather-gift text-warning fs-14"></i>
                                    <span>{{ $bday->full_name }}</span>
                                </div>
                            </td>
                            <td class="py-2.5 pe-4 text-end border-bottom" style="border-color: #f1f5f9;">
                                <span class="badge px-2.5 py-1 fs-11 fw-semibold rounded-pill" style="background: #fef3c7; color: #d97706;">Birthday</span>
                            </td>
                        </tr>
                    @endforeach
                    @foreach($annivs as $anniv)
                        <tr>
                            <td class="py-2.5 ps-4 border-bottom" style="border-color: #f1f5f9;">
                                <div class="fw-semibold text-dark fs-13 d-inline-flex align-items-center gap-2" style="color: #1e293b !important;">
                                    <i class="feather-award text-primary fs-14"></i>
                                    <span>{{ $anniv->full_name }}</span>
                                </div>
                            </td>
                            <td class="py-2.5 pe-4 text-end border-bottom" style="border-color: #f1f5f9;">
                                <span class="badge px-2.5 py-1 fs-11 fw-semibold rounded-pill" style="background: #e0e7ff; color: #4338ca;">Work Anniversary</span>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
