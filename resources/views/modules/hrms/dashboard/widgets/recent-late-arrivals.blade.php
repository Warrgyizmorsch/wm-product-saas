<div class="card border-0 mb-0 h-100 shadow-sm" style="border-radius: 16px; background: #ffffff;">
    <div class="card-header bg-white pt-3.5 pb-2.5 px-4 d-flex align-items-center justify-content-between border-bottom-0">
        <div class="d-flex align-items-center gap-2">
            ...
            <h6 class="fw-bold mb-0 text-dark fs-14" style="color: #0f172a !important;">Late Arrivals (Last 7 Days)</h6>
        </div>
                        ...
                        @foreach($recentLateArrivals as $late)
                            <tr>
                                <td class="py-2.5 ps-4 border-bottom" style="border-color: #f1f5f9;">
                                    <div class="fw-semibold text-dark fs-13" style="color: #1e293b !important;">{{ $late->employee?->full_name ?? 'Employee' }}</div>
                                </td>
                                <td class="py-2.5 pe-4 text-end border-bottom" style="border-color: #f1f5f9;">
                                    <span class="badge px-2.5 py-1 fs-11 fw-semibold rounded-pill" style="background: #ffedd5; color: #c2410c;">Late {{ $late->late_minutes ?? 15 }} mins</span>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
