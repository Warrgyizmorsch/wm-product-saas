...
<div class="row g-4 align-items-stretch mb-2">
    ...
    <div class="col-lg-9">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                {{-- One currency per tenant: shown for reference, set on the tenant (Tenant Console → Tenants). --}}
                @php($tenantCurrency = company_currency())
                <x-ui.odoo-form-ui type="input" label="{{ __('hrms.org.currency') }}" name="currency_display" id="{{ $prefix }}_currency_display"
                                  :value="$tenantCurrency['code'] . ' — ' . $tenantCurrency['name']" :readonly="true"
                                  helperText="Every company in this tenant uses the tenant's currency." />
            </div>
            <div class="col-md-6">
