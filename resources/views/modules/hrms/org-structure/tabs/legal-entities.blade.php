                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex justify-content-end gap-1">
                                    ...
                                    <x-ui.icon-btn variant="primary" icon="feather-edit" class="btn-edit-company" data-bs-toggle="modal" data-bs-target="#editCompanyModal" data-company="{{ base64_encode($company->toJson()) }}" title="Edit" />
