<div class="row">
    <!-- List Table Card -->
    <div class="col-12">
        <x-ui.card title="{{ __('hrms.org.legal_entities') }}" stretch bodyClass="p-0">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <x-ui.sort-dropdown label="{{ __('hrms.common.sort') }}">
                        ...
                        <a class="dropdown-item d-flex justify-content-between align-items-center py-2 {{ $filters['co_sort'] === 'legal_asc' ? 'active' : '' }}" href="{{ request()->fullUrlWithQuery(['tab' => 'legal-entities', 'co_sort' => 'legal_asc']) }}">
                            <span>{{ __('hrms.org.sort_legal_asc') }}</span>
                        ...
                        <a class="dropdown-item d-flex justify-content-between align-items-center py-2 {{ $filters['co_sort'] === 'legal_desc' ? 'active' : '' }}" href="{{ request()->fullUrlWithQuery(['tab' => 'legal-entities', 'co_sort' => 'legal_desc']) }}">
                            <span>{{ __('hrms.org.sort_legal_desc') }}</span>
                        ...
                        <form method="GET" action="{{ route('hrms.org.index') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="co_status" class="form-select" style="border-radius: 6px; border: 1px solid #cbd5e1; font-size: 13px;">
                                    ...
                                    <option value="1" @selected($filters['co_status'] === '1')>{{ __('hrms.employees.frm_status_active') }}</option>
                                    <option value="0" @selected($filters['co_status'] === '0')>{{ __('hrms.employees.frm_status_inactive') }}</option>
                                </select>
                            </div>
                            
                            <div class="d-flex gap-2 justify-content-end mt-4">
                                <a href="{{ route('hrms.org.index', ['tab' => 'legal-entities']) }}" class="btn btn-sm btn-light text-uppercase fw-bold py-2 px-3" style="border-radius: 6px; font-size: 11px; letter-spacing: 0.05em; background-color: #f1f5f9; border: 1px solid #e2e8f0; color: #475569;">{{ __('hrms.common.reset') }}</a>
                ...
                <table class="table table-hover mb-0 align-middle">
                    ...
                    <tbody id="companiesTableBody">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <form action="{{ route('hrms.company.destroy', $company->id) }}" method="POST" class="d-inline" onsubmit="return confirm('{{ __('hrms.org.confirm_delete_co') }}');">
                                    @csrf
                                    @method('DELETE')
