<div class="row">
    ...
    <div>
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 pb-2 border-bottom">
            <h5 class="fw-bold mb-0 text-dark" style="font-size: 16px;">{{ __('hrms.org.departments') }}</h5>
                ...
                <table class="table table-hover mb-0 align-middle" style="table-layout: fixed; width: 100%;">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th style="width: 26%;">{{ __('hrms.org.tbl_dept_name') }}</th>
                            <th style="width: 15%;">{{ __('hrms.org.tbl_code') }}</th>
                            <th style="width: 24%;">{{ __('hrms.org.branches') }}</th>
                            <th style="width: 20%;">{{ __('hrms.org.tbl_parent_dept') }}</th>
                    ...
                    <tbody id="departmentsTableBody">
                        ...
                        <tr>
                            ...
                            <td style="word-break: break-word; overflow-wrap: anywhere; white-space: normal;"><span class="fw-bold text-dark">{{ $d->name }}</span></td>
                            <td style="word-break: break-word; overflow-wrap: anywhere;"><code style="word-break: break-all; white-space: normal;">{{ $d->code }}</code></td>
                            <td style="word-break: break-word; overflow-wrap: anywhere; white-space: normal;">{{ $d->branch->name ?? ($d->businessUnit->name ?? ($d->company->company_name ?? 'N/A')) }}</td>
                            <td style="word-break: break-word; overflow-wrap: anywhere; white-space: normal;">{{ $d->head ? ($d->head->first_name . ' ' . $d->head->last_name) : 'N/A' }}</td>
                            <td>
                                @if($d->status)
