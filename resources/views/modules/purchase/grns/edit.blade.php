                ...
                <div class="card border-0 shadow-sm bg-white mb-4 odoo-sheet">
                    ...
                    <div class="card-body p-4 p-md-5">
                                ...
                                <table class="table table-bordered align-middle mb-0 fs-12 text-dark">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th style="width: 12%;" class="text-end">{{ __('purchase.total_amount') }} ({{ active_currency_symbol() }})</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-2 mt-4 pt-3 border-top">
                            <x-ui.button href="{{ route('grns.show', $grn->id) }}" variant="light" class="border px-4 py-2 fs-13">
                                {{ __('purchase.cancel') }}
                            </x-ui.button>
