                    ...
                    <div class="mt-5">
                        ...
                        <div class="table-responsive">
                            <table class="odoo-table" id="prItemsTable">
                                ...
                                <tbody>
                                    <!-- Row template index will start at 0 -->
                                    <tr class="item-row" data-index="0">
                                        ...
                                        <td>
                                            <x-ui.odoo-form-ui type="input" name="items[0][quantity]" inputType="number" class="text-end qty-input" step="0.0001" min="0.0001" required="true" placeholder="0.00" />
                                        </td>
                                        <td>
                                            <x-ui.odoo-form-ui type="input" name="items[0][estimated_cost]" inputType="number" class="text-end cost-input" step="0.01" min="0" required="true" placeholder="0.00" />
                                        </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            function toggleSourceRefs() {
                ...
                $('.source-ref-container select').val('').trigger('change');
                $('.source-ref-container input').val('');
