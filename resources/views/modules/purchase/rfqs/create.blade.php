...
@section('title', __('purchase.create_rfq') . ' | SaaS ERP')
@section('page-title', __('purchase.new_rfq'))
@section('breadcrumb')
    <a href="{{ route('purchase.rfqs.index') }}">{{ __('purchase.rfqs') }}</a> &gt; {{ __('purchase.create') }}
@endsection
            ...
            <div class="card border-0 shadow-sm p-4 p-md-5 bg-white">
                <form action="{{ route('purchase.rfqs.store') }}" method="POST" id="createRfqForm" class="odoo-sheet">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom flex-wrap gap-2">
                        <div>
                            <h4 class="fw-bold text-dark mb-0">{{ __('purchase.create_rfq') }}</h4>
                            <small class="text-muted fs-12">{{ __('purchase.create_rfq_help') }}</small>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 fs-13 text-dark">
                        ...
                        <div class="col-md-6 border-end">
                            ...
                            <x-ui.odoo-form-ui type="input" label="{{ __('purchase.rfq_date') }}" name="rfq_date" inputType="date" :value="old('rfq_date', date('Y-m-d'))" required="true" />
                        ...
                        <div class="col-md-6">
                            ...
                            <x-ui.odoo-form-ui type="textarea" label="{{ __('purchase.notes') }}" name="notes" rows="6" placeholder="{{ __('purchase.notes_placeholder_rfq') }}">{{ old('notes') }}</x-ui.odoo-form-ui>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-end gap-2 mt-4 pt-3 border-top">
                        <x-ui.button href="{{ route('purchase.rfqs.index') }}" variant="light" class="border px-4 py-2 fs-13">
                            {{ __('purchase.cancel') }}
                        </x-ui.button>
                        <x-ui.button type="submit" variant="primary" icon="feather-save" class="px-4 py-2 fs-13 fw-bold shadow-sm">
                            {{ __('purchase.save_rfq') }}
                        </x-ui.button>
                    </div>
                </form>
            </div>
