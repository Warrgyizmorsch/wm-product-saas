        ...
        <form action="{{ route('crm.deals.store') }}" method="POST" id="dealCreateForm">
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-lg-6">
                    ...
                    <x-ui.odoo-form-ui type="select" :label="__('crm.customer_account')" name="crm_account_id" id="crm_account_id" required="true" data-master="account">
                ...
                <div class="col-lg-6">
                    ...
                    <x-ui.odoo-form-ui type="select" :label="__('crm.source')" name="lead_source">
                        ...
                        @foreach (['Direct Inquiry', 'Website Form', 'Web Search', 'Meta Ads', 'IndiaMART', 'TradeIndia', 'Justdial', 'Cold Call', 'Referral', 'Employee Referral', 'Partner', 'Advertisement', 'Trade Show', 'WhatsApp Bot', 'WhatsApp', 'Email', 'Phone Call', 'Walk In', 'LinkedIn', 'Google Ads', 'Other'] as $srcOption)
                            <option value="{{ $srcOption }}" @selected(old('lead_source') === $srcOption)>{{ \Illuminate\Support\Facades\Lang::has('crm.sources.' . $srcOption) ? __('crm.sources.' . $srcOption) : $srcOption }}</option>
                        @endforeach
                    </x-ui.odoo-form-ui>
