    ...
    <div class="erp-single-panel bg-white">
        ...
        <x-ui.odoo-form-ui type="sheet">
            <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
                ...
                <a href="{{ route('sales.orders.show', $order->id) }}" class="btn btn-sm btn-light border">Cancel</a>
            </div>
            ...
            <div class="row mt-4 pt-3 border-top text-dark fs-13">
                <div class="col-md-7">
                    <div class="pe-md-4">
                        <div class="mb-3">
                            ...
                            <textarea name="terms_conditions" class="form-control" rows="3" placeholder="Define payment terms, delivery schedules, etc." style="border-radius: 4px; font-size: 13px;">{{ old('terms_conditions', $order->terms_conditions) }}</textarea>
                        </div>
                        <div class="mb-3">
                ...
                <div class="col-md-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                        ...
                        <input type="number" name="adjustment" id="adjustmentInput" class="form-control form-control-sm text-end fw-bold" style="width: 100px; border-radius: 4px;" value="{{ old('adjustment', $order->adjustment) }}" step="0.01">
                    </div>
