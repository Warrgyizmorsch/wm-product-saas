        ...
        <x-ui.odoo-form-ui type="sheet">
            ...
            <div class="row g-4 mb-4 fs-13 text-dark">
                ...
                <div class="col-md-6">
                    ...
                    <x-ui.odoo-form-ui type="input" inputType="number" label="Freight Amount ({{ currency_symbol() }})" name="freight_amount" id="freightAmountInput" :value="old('freight_amount', 0)" min="0" step="0.01" />
            </div>
