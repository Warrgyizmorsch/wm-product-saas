        ...
        <div class="row g-4">
            ...
            <div class="col-xl-12">
                <x-ui.card title="Routing General Header">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <x-ui.select label="Target Finished/Semi-Finished Product" name="product_id" :options="['' => 'Select Product'] + $products->pluck('name', 'id')->toArray()" selected="{{ old('product_id', $selectedProductId ?? '') }}" required />
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                            ...
                            ]" selected="{{ old('is_default', '1') }}" required />
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" name="description" rows="3" placeholder="Enter high-level description, manufacturing objectives, or routing change logs...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </x-ui.card>
            </div>

            <!-- Full Width: Operations Dynamic Grid -->
            <div class="col-xl-12">
            ...
            <div class="col-12 text-end">
                <button type="submit" class="btn btn-primary btn-lg px-5">
                    <i class="feather-save me-2"></i>Save Routing Draft
                </button>
            </div>
        </div>
    </form>
