        ...
        <form action="{{ route('production.maintenance.schedules.update', $schedule->id) }}" method="POST">
            ...
            <x-ui.odoo-form-ui type="sheet">
                ...
                <div class="row g-4 mb-4 fs-13 text-dark">
                    <div class="col-md-6">
                        ...
                        <x-ui.odoo-form-ui type="select" label="Priority" name="priority" :required="true"
                            ...
                            <option value="medium" @selected(old('priority', $schedule->priority) == 'medium')>{{ __('production.priority_medium') }}</option>
                            <option value="low" @selected(old('priority', $schedule->priority) == 'low')>{{ __('production.priority_low') }}</option>
                            <option value="high" @selected(old('priority', $schedule->priority) == 'high')>{{ __('production.priority_high') }}</option>
                            <option value="critical" @selected(old('priority', $schedule->priority) == 'critical')>{{ __('production.critical') }}</option>
                        </x-ui.odoo-form-ui>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                    <a href="{{ route('production.maintenance.schedules.index') }}" class="btn btn-light border px-4">{{ __('production.cancel') }}</a>
