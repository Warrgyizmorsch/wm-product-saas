            ...
            <x-ui.odoo-form-ui type="sheet">
                ...
                <div class="row g-4 mb-4 fs-13 text-dark">
                    ...
                    <div class="col-md-6">
                        ...
                        <x-ui.odoo-form-ui type="input" :label="__('production.bom_name')" name="bom_name" placeholder="{{ __('production.bom_name_placeholder') }}" :value="old('bom_name', $bom->bom_name)" :required="true" :error-text="$errors->first('bom_name')" alpineError="errors.bom_name" />
                    ...
                    <div class="col-md-6">
                        ...
                        <x-ui.odoo-form-ui type="textarea" :label="__('production.revision_notes')" name="notes" placeholder="{{ __('production.notes_placeholder') }}" rows="3" :error-text="$errors->first('notes')" alpineError="errors.notes">{{ old('notes', $bom->notes) }}</x-ui.odoo-form-ui>
                    </div>
                </div>
                ...
                <div class="border rounded mb-4">
                    ...
                    <div class="bg-white" 
                        ...
                        <div class="row g-3 fs-13 text-dark">
                            <div class="col-md-6">
                                <x-ui.odoo-form-ui type="input" :label="__('production.version')" name="version" placeholder="{{ __('production.version_placeholder') }}" :value="old('version', $bom->version)" :required="true" :error-text="$errors->first('version')" alpineError="errors.version" />
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <x-ui.odoo-form-ui type="input" :label="__('production.revision_reason') ?? 'Revision Reason'" name="revision_reason" placeholder="{{ __('production.revision_reason_placeholder') }}" :value="old('revision_reason', $bom->revision_reason)" :error-text="$errors->first('revision_reason')" alpineError="errors.revision_reason" />
                            </div>
                        </div>
                    </div>
                </div>
