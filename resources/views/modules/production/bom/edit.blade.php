            ...
            <x-ui.odoo-form-ui type="sheet">
                ...
                <div class="row g-4 mb-4 fs-13 text-dark">
                    ...
                    <div class="col-md-6 border-end">
                        <x-ui.odoo-form-ui type="input" label="BOM Number" name="bom_number" placeholder="e.g. BOM-XYZ-001" :value="old('bom_number', $bom->bom_number)" :required="true" :error-text="$errors->first('bom_number')" alpineError="errors.bom_number" />
                        ...
                        <x-ui.odoo-form-ui type="input" label="BOM Name" name="bom_name" placeholder="e.g. Standard Red Door BOM" :value="old('bom_name', $bom->bom_name)" :required="true" :error-text="$errors->first('bom_name')" alpineError="errors.bom_name" />
                    ...
                    <!-- Right Column -->
                    <div class="col-md-6">
                        <x-ui.odoo-form-ui type="input" label="Base Quantity" name="base_quantity" inputType="number" step="any" placeholder="1.0" :value="old('base_quantity', $bom->base_quantity)" :required="true" :error-text="$errors->first('base_quantity')" alpineError="errors.base_quantity" />
                        ...
                        <x-ui.odoo-form-ui type="textarea" label="Description" name="notes" placeholder="Max. 500 characters" rows="3" :error-text="$errors->first('notes')" alpineError="errors.notes">{{ old('notes', $bom->notes) }}</x-ui.odoo-form-ui>
                    </div>
                </div>
                ...
                <div class="border rounded mb-4">
                    ...
                    <div class="bg-white" 
                        ...
                        <div class="row g-3 fs-13 text-dark">
                            <div class="col-md-6">
                                <x-ui.odoo-form-ui type="input" label="Version ID" name="version" placeholder="e.g. 1.0.0" :value="old('version', $bom->version)" :required="true" :error-text="$errors->first('version')" alpineError="errors.version" />
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <x-ui.odoo-form-ui type="input" label="Start Date" name="effective_date" inputType="date" :value="old('effective_date', $bom->effective_date ? $bom->effective_date->format('Y-m-d') : date('Y-m-d'))" :required="true" :error-text="$errors->first('effective_date')" alpineError="errors.effective_date" />
                            </div>
                            <div class="col-md-6">
                                <x-ui.odoo-form-ui type="input" label="Expiry Date" name="expiry_date" inputType="date" :value="old('expiry_date', $bom->expiry_date ? $bom->expiry_date->format('Y-m-d') : '')" :error-text="$errors->first('expiry_date')" alpineError="errors.expiry_date" />
                            </div>
                            <div class="col-md-12">
                                <x-ui.odoo-form-ui type="input" label="Revision Reason" name="revision_reason" placeholder="e.g. Engineering specification update" :value="old('revision_reason', $bom->revision_reason)" :error-text="$errors->first('revision_reason')" alpineError="errors.revision_reason" />
                            </div>
                        </div>
                    </div>
                </div>
