                ...
                <form action="{{ route('inventory.products.update', $product) }}" method="POST" id="productForm" class="odoo-sheet">
                    ...
                    <div class="row g-4 mb-4 fs-13 text-dark">
                        ...
                        <div class="col-lg-6">
                            ...
                            <x-ui.odoo-form-ui type="input" :label="__('inventory.selling_price')" name="selling_price" value="{{ $product->selling_price }}" inputType="number" step="0.01" placeholder="Selling Price ({{ currency_symbol() }})" />
                            ...
                            <x-ui.odoo-form-ui type="input" :label="__('inventory.cost_price')" name="cost_price" value="{{ $product->cost_price }}" inputType="number" step="0.01" placeholder="Purchase Cost ({{ currency_symbol() }})" />
