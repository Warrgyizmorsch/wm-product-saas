...
@section('title', 'WhatsApp Web Setup & Device Linking | Platform Settings')
@section('page-title', 'WhatsApp Web Integration')
@section('breadcrumb', 'Platform / Settings / WhatsApp Setup')
...
<script>
    $(document).ready(function() {
        ...
        $('#btnDisconnectWA').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('platform.whatsapp.disconnect') }}",
                method: "DELETE",
                data: { _token: "{{ csrf_token() }}" },
                success: function(res) {
        ...
        $('#sendQuickWaForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('platform.whatsapp.sendMessage') }}",
                method: "POST",
                data: form.serialize(),
                success: function(res) {
        ...
        $('#saveWaDbConfigForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('platform.whatsapp.updateConfig') }}",
                method: "POST",
                data: form.serialize(),
                success: function(res) {
                    btn.prop('disabled', false).html(origHtml);
