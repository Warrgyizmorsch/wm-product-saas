...
class FurnitureManufacturingDemoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        \App\Domains\Production\Models\ProductionDashboardPreference::updateOrCreate(
        ...
        $this->command->info('');
        $this->command->info('✅ FurnitureManufacturingDemoSeeder complete!');
        $this->command->info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
        $this->command->info('  Products  : Dining Chair DC-1, Dining Table DT-1');
        $this->command->info('  Work Centers: 4 depts, 6 leaf work centers');
        $this->command->info('  Machines  : CNC Router, Belt Sander, Spray, Press');
        $this->command->info('  Shifts    : Day (07:00-15:30), Evening (15:30-23:00)');
        $this->command->info('  BOMs      : 3 (Chair Legs, Chair, Table) with sub-BOM link');
        $this->command->info('  Routings  : 3 (Chair Legs, Chair 5-step, Table 5-step)');
        $this->command->info('  Scenarios : A(Perfect) B(Breakdown) C(Rework) D(Scrap) E(Live)');
        $this->command->info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    }
}
