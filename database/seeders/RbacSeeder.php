...
class RbacSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->grant($roles['hr_manager'], [
            ...
            'hrms.documents.view' => $permissions['hrms.documents.view'],
            'hrms.documents.manage' => $permissions['hrms.documents.manage'],
            'hrms.document_templates.manage' => $permissions['hrms.document_templates.manage'],
    ...
    private function seedPermissions(): array
    {
        $definitions = [
            ...
            ['name' => 'hrms.documents.view', 'module' => 'hrms', 'entity' => 'documents', 'action' => 'view'],
            ['name' => 'hrms.documents.manage', 'module' => 'hrms', 'entity' => 'documents', 'action' => 'manage'],
            ['name' => 'hrms.document_templates.manage', 'module' => 'hrms', 'entity' => 'document_templates', 'action' => 'manage'],
