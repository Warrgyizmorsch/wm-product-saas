...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('vendor_bills', function (Blueprint $table) {
            if (!Schema::hasColumn('vendor_bills', 'discount_type')) {
                $table->string('discount_type')->default('without_discount')->after('vendor_invoice_number');
            }
            if (!Schema::hasColumn('vendor_bills', 'tax_type')) {
                $table->string('tax_type')->default('order_wise_tax')->after('discount_type');
            }
            if (!Schema::hasColumn('vendor_bills', 'gst_type')) {
                $table->string('gst_type')->default('cgst_sgst')->after('tax_type');
            }
            ...
            if (!Schema::hasColumn('vendor_bills', 'discount_amount')) {
    ...
    public function down(): void
    {
        Schema::table('vendor_bills', function (Blueprint $table) {
            if (Schema::hasColumn('vendor_bills', 'discount_type')) {
                $table->dropColumn(['discount_type', 'tax_type', 'gst_type', 'freight_terms', 'freight_amount', 'discount_amount', 'cgst_amount', 'sgst_amount', 'igst_amount']);
            }
        });
    }
};