...
/**
 * Output GST, input credit, reverse charge and net GST payable for a date
 * range. Shared by the GST Summary report and the Accounting dashboard so
...
class GstSummaryService
{
    /**
     * @return array{
     *     output: array{taxable: float, cgst: float, sgst: float, igst: float},
     *     input: array{taxable: float, cgst: float, sgst: float, igst: float},
     *     rcm: array{taxable: float, cgst: float, sgst: float, igst: float},
     *     rcmItc: array{taxable: float, cgst: float, sgst: float, igst: float},
     *     payable: array{cgst: float, sgst: float, igst: float, total: float}
     * }
     */
