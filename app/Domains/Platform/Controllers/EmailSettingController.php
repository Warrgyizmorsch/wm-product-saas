...
class EmailSettingController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->route('platform.emailSettings.index')->with('success', $msg);
    ...
    public function destroy(int $id): RedirectResponse
    {
        try {
            ...
            return redirect()->route('platform.emailSettings.index')->with('success', "SMTP Email Account '{$accountName}' deleted successfully!");
        } catch (\Throwable $e) {
            return redirect()->route('platform.emailSettings.index')->with('error', "Failed to delete account: " . $e->getMessage());
        }
    }
